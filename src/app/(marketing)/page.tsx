...
export default async function MarketingHomePage() {
  ...
  return (
    <main>
      ...
      <section className="mx-auto max-w-7xl px-5 py-18 sm:px-7 sm:py-24"><div className="rounded-[2rem] bg-blue-700 px-6 py-10 text-white shadow-xl shadow-blue-700/20 sm:px-10 sm:py-12"><p className="text-xs font-bold tracking-[0.12em] text-blue-100 uppercase">Ready when you are</p><div className="mt-3 flex flex-col gap-6 md:flex-row md:items-end md:justify-between"><div><h2 className="max-w-2xl text-3xl font-bold tracking-tight sm:text-4xl">Find a plan that fits your institute.</h2><p className="mt-3 max-w-xl text-blue-100">Explore LearningMS subscription options and choose the right starting point for your team.</p></div><Link href="/plans" className="inline-flex shrink-0 items-center justify-center gap-2 rounded-xl bg-white px-5 py-3 text-sm font-semibold text-blue-700 transition-colors hover:bg-blue-50">View plans <ArrowRight className="size-4" /></Link></div></div></section>
    </main>
  );
}
