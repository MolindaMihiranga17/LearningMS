...
export default async function AnnouncementsPage() {
  ...
  return <div className="flex flex-col gap-6"><div className="flex items-center justify-between"><div><h1 className="text-2xl font-semibold">Announcements</h1><p className="mt-1 text-sm text-muted-foreground">Updates shared with your classes and courses.</p></div>{announcementDialog}</div>{content}</div>;
}
