...
export const INSTITUTE_ADMIN_NAV: NavItem[] = [
  ...
  { label: "Academic analytics", href: "/academic-analytics", icon: TrendingUp, group: "Overview" },
...
export const INSTITUTE_STAFF_NAV: NavItem[] = [
  ...
  { label: "Messages", href: "/messages", icon: MessageSquare, group: "Overview" },
  ...
  { label: "Academic analytics", href: "/academic-analytics", icon: TrendingUp, group: "Teaching", staffPermission: "classes" },
...
export const STUDENT_NAV: NavItem[] = [
  ...
  { label: "Messages", href: "/messages", icon: MessageSquare, group: "Learning" },
